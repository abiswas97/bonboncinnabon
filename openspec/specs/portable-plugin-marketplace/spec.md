# portable-plugin-marketplace Specification

## Purpose

Define the canonical marketplace model and generated packages that make
repository-owned plugins directly installable in Claude and Codex.
